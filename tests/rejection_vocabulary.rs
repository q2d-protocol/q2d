...
fn every_reason_this_module_produces_matches_the_corpus() {
    ...
    let ours: &[(&str, Rejected)] = &[
        ...
        ("core_object_duplicate_key", Rejected::CoreObjectDuplicateKey),
        ("core_object_float", Rejected::CoreObjectFloat),
        ("core_object_too_deep", Rejected::CoreObjectTooDeep),
        ("core_object_too_many_members", Rejected::CoreObjectTooManyMembers),
        ("core_object_string_too_long", Rejected::CoreObjectStringTooLong),
