...
Which is the reason the third row is the one this system takes rather than a
nicety. With the budget and the cache in one store, the window does not exist;
with them apart, the over-charge is real and permanent, and the only argument for
it is that the alternative is worse.
