...
| `requester/verify/` | Valid; below-floor suite; bad signature; unresolvable responder key; tampered result; **header/payload suite mismatch and key-id mismatch**, each rejected at step 4a |
