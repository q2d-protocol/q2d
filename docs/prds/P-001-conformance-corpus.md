...
| 14 | Author `ordering/` section | One vector per rejection step 1–15, plus 9a and 11a. **Unblocked** — steps 4 and below need a signed envelope, which is now producible; steps 1–3 are pre-verification and need only the serializer |
