...
itself by narrowing composition, per shape, per §3.2, **composing two narrowings
of one dimension to their greatest lower bound per §3.3 and failing closed on an
empty one**; validate output against it;
