    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                "is the top-level value of that serialization and **still "
                "operation data** — `serialization.md` §3 makes protocol level "
                "a property of what a value is rather than of where it sits, so "
                "being at the top makes it the root of some bytes and not a "
                "protocol structure. An "
